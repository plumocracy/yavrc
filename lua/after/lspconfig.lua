-- Ripped right from kickstart. https://github.com/nvim-lua/kickstart.nvim/blob/master/init.lua
-- Useful LSP status stuffs
...
local nonelsgroup = vim.api.nvim_create_augroup("LspFormatting", {})
